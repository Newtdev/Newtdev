...
// Social Icons Component (update your existing Icons.js)
const Icons = ({ className, ariaLabel }) => (
  <div className={className} aria-label={ariaLabel}>
    <a
      href="https://github.com/NewtDev"
      target="_blank"
      rel="noopener noreferrer"
      className="p-2 hover:text-secondary-light text-white transition-colors duration-300"
    ...
    <a
      href="https://linkedin.com/in/thomas-ejembi-690843101"
      target="_blank"
      rel="noopener noreferrer"
      className="p-2 hover:text-secondary-light text-white transition-colors duration-300"
